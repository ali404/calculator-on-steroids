	...
	CalculatorApp = (function() {
		...
		*/
		var Calculus = (function() {
			...
			*			under that property the value is checked
			*/
			...
			*	taken from stackOverflow , credits to Mike Samuel
			*	return the decimals of any number
			*/
			...
			*	@return void
			*	paints the input to error state(red shadow);
			*/
			...
			*	@param CssClass type string (css valid class)
			*	@return void
			*	paints the input to the normal state(gray shadow);
			*/
			...
			*	@param void
			*	@return void
			*	loads all DOM event handlers in INIT function
			*/
			var _loadHandlers = function() {
